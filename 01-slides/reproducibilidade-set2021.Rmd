...
- Bad computational policies (aka "it works on my machine") and lack of incentives for sharing code and data.
...
- Version control (data & code) 
  ...
  - **Cloud versioning** (Dropbox/GoogleDrive/OneDrive)

--

- Intructions for running the R code (perhaps in a git style Readme.md file?)
...
- Containers are the _state-of-art_  for code execution and reproducibility (it garantes a particular arquitecture, forever).
